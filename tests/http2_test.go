  ...
  "bars": {
    "b1": {
      ...
      "meta": {
        ...
        "defaultversionid": "1",
        "defaultversionurl": "http://localhost:8181/dirs/d1/bars/b1/versions/1",
...
func TestHTTPModelSchema(t *testing.T) {
	...
	xHTTP(t, reg, "GET", "/model?schema="+XREGSCHEMA, "", 200, `{
  "attributes": {
    "specversion": {
      "name": "specversion",
      "type": "string",
...
`)
	...
	xHTTP(t, reg, "GET", "/model?schema="+XREGSCHEMA+"/"+SPECVERSION, "", 200, `{
  "attributes": {
    "specversion": {
      "name": "specversion",
      "type": "string",
...
`)
	...
	xHTTP(t, reg, "GET", "/model?schema="+XREGSCHEMA+"/bad", "", 400,
      ...
      "files": {
        ...
        "f3": {
          ...
          "meta": {
            ...
            "defaultversionid": "1",
            "defaultversionurl": "http://localhost:8181/dirs/d1/files/f3/versions/1",
            "defaultversionsticky": false
          },
          "versionsurl": "http://localhost:8181/dirs/d1/files/f3/versions",
          "versions": {
        ...
        "f4": {
          ...
          "meta": {
            ...
            "defaultversionid": "1",
            "defaultversionurl": "http://localhost:8181/dirs/d1/files/f4/versions/1",
            "defaultversionsticky": false
          },
          "versionsurl": "http://localhost:8181/dirs/d1/files/f4/versions",
          "versions": {
        ...
        "f5": {
          ...
          "meta": {
            ...
            "defaultversionid": "1",
            "defaultversionurl": "http://localhost:8181/dirs/d1/files/f5/versions/1",
            "defaultversionsticky": false
          },
